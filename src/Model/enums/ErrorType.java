...
public enum ErrorType {
    ...
    MONEY_IS_NOT_ENOUGH("you dont have enough money\nfor buy this card or item"),
    MANA_IS_NOT_ENOUGH_INSERT("you dont have enough mana\n to insert this card or item"),
    MANA_IS_NOT_ENOUGH_USE_SP("you dont have enough mana\n to use special power"),
