...
public class MultiPlayerMoodPage extends Page {

    private BattleMenuPage battleMenuPage = BattleMenuPage.getInstance();

    public MultiPlayerMoodPage(){
        start();
    }

    private static Pane root = new Pane();
    private MultiPlayerMoodCtrl controller;

    @Override
    public void start() {
        try {
            FXMLLoader fxmlLoader = new FXMLLoader(getClass().getResource("../layout/GameMood2.fxml"));
